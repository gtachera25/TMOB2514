...
with market_definition as (
    ...
    from {{ source('project_tmob2514','report_cbs_in_footprint') }} fpt
...
-- Demos
left join {{source('project_tmob2514','report_cbs_in_footprint')}} fpt on base.market = fpt.census_block_code_2020
