...
with market_definition as (
    ...
    from {{ source('project_tmob2514','cbs_in_footprint_missing_pen') }} fpt
...
-- Demos
left join {{source('project_tmob2514','cbs_in_footprint_missing_pen')}} fpt on base.market = fpt.census_block_code_2020
